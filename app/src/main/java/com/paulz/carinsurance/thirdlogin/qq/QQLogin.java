...
//		com.paulz.carinsurance.model.UserInfo userInfo=AppStatic.getInstance().getUser();
								...
								public void onSuccess(Object obj) {
									...
									if(obj instanceof JSONObject){
										...
										if(retCode==0){
											...
											com.paulz.carinsurance.model.UserInfo userInfo =new com.paulz.carinsurance.model.UserInfo();
